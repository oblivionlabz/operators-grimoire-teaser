...
Three free skills from [**The Claude Code Operator's Grimoire**](https://grimoire.oblivionlabz.net) — a curated bundle of fourteen skills that turns Claude Code into a disciplined senior operator.
...
These three skills ship free. The full bundle — spec-driven dev chain, orchestration topologies, evals harness, obsidian vault, claude-agent SDK scaffold, and nine more — is $99 one-time at **[grimoire.oblivionlabz.net](https://grimoire.oblivionlabz.net)**.

## Install

```bash
git clone https://github.com/oblivionlabz/operators-grimoire-teaser.git
cp -r operators-grimoire-teaser/skills/* ~/.claude/skills/
...
- **Get it:** [grimoire.oblivionlabz.net](https://grimoire.oblivionlabz.net) · or direct on [Gumroad](https://vermidox.gumroad.com/l/operators-grimoire)
